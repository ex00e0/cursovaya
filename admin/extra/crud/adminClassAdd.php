...
?>
            <main>
                ...
                <form class="formEditFlight" action="addClass.php" method="post" enctype="multipart/form-data">                                                                      <!--форма изменения данных о рейсе-->
                    ...
                    <div class="gridEdit headlineEditGrid">
                        <div class="inputSelect2Cols">
                            <input type='number' class="inputAdmin adminCol1" name="hand_luggage" value="" required min="0" max="50">
                              
                            <label class="labelAdmin adminCol1">Ручная кладь (кг)</label>
                            <input type='number' class="inputAdmin adminCol2" name="luggage" value="" required min="0" max="50">
