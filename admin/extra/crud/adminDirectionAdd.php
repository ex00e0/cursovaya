...
?>
            <main>
                ...
                <form class="formEditFlight" action="addDirection.php" method="post" enctype="multipart/form-data">                                                                      <!--форма изменения данных о рейсе-->
                    ...
                    <div class="gridEdit headlineEditGrid">
                        <div class="inputSelect2Cols">
                            <input type='text' class="inputAdmin adminCol1" name="code" value="" required maxlength="3">
